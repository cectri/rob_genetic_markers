...
#ggsave("FR_CPS.pdf", width = 15, height = 10, path = "~/Library/CloudStorage/OneDrive-Chalmers/PhD/Experimental_Data/Robusntess application on existing dataset/R_scripts/genetic_markers_robustness/plots/CPS_fitness")
```
...
P +  geom_point(data=df_R_costanzo, size=5, aes(x=strain, y=robustness_n, color=strain))+
  ...
  scale_color_manual(values=c("#922A2B","#922A2B","#922A2B","#E2C140","#E2C140","#E2C140","#E2C140","#E2C140","#E2C140", "#4775A5", "#4775A5", "#4775A5", "#4775A5", "#4775A5","#5B9589","#5B9589")) +
  geom_hline(aes(yintercept = robustness_n), 
              data = filter(df_R_costanzo, strain == "CENPK"),
             linetype = "dashed", color = "#5B9589")+
  bbc_style()+
  guides(color="none")+
  theme(strip.text = element_text(face="bold"),
        text = element_text(size = 15),
        axis.text.x = element_text(size = 20, angle=90, vjust = 0.5,hjust = 1))
ggsave("FR_CPS_onlycostanzo.pdf", width = 15, height = 10, path = "~/Library/CloudStorage/OneDrive-Chalmers/PhD/Experimental_Data/Robusntess application on existing dataset/R_scripts/genetic_markers_robustness/plots/CPS_fitness")
```
