...
mutate(mumax = ifelse(r2 <= 0.99 & mumax != 0, NA, mumax))%>%
  select(-`y0`)
...
p <- ggplot(data= results, 
  ...
  stat_compare_means(method = "wilcox.test", label = "p.signif", 
                     ref.group = "CEN.PK113-7D", size=8, hide.ns = TRUE, label.y = 0.15)+
  guides(fill="none")+
...
#ggsave("FR_BPS_2.pdf", device=cairo_pdf, width = 15, height = 10, path = "~/Library/CloudStorage/OneDrive-Chalmers/PhD/Experimental_Data/Robusntess application on existing dataset/R_scripts/genetic_markers_robustness/plots/BPS_fitness")
```
